 ...
 */
public class WindowsBooterDaemonGenerator extends AbstractLogEnabled implements DaemonGenerator
{
    /**
    ...
    {
        ScriptUtils.createBinScript( true, descriptor, project, localRepository, outputDirectory );
